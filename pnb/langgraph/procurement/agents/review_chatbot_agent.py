...
For the template tool, the Bid Evaluation Report template that you will send will be a name of a template and python dictionary as context whose fields you get from the bid model dump.
