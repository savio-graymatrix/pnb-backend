...
4) retriever_tool: To access data about the tender fro the database via a query


""".format(
                # tender_info=tender_info, tender_rule_info=tender_rule_info
            ),
            tools=[md_to_pdf_tool, get_system_time, web_search_tool, retriever_tool],
        )
