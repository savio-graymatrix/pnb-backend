...
from pnb.langgraph.procurement.workflows.query_chatbot_graph import (
    setup_query_chatbot_graph,
)
from pnb.langgraph.procurement.workflows.review_chatbot_graph import (
    setup_review_chatbot_graph,
)
from pnb.langgraph.procurement.workflows.tender_chatbot_graph import (
    setup_tender_chatbot_graph,
)
from pnb.langgraph.procurement.workflows.tender_rule_graph import (
    setup_tender_rule_graph,
)
    ...
    PROCUREMENT_GRAPHS.update(
        {
            ...
            "review_chatbot": await setup_review_chatbot_graph(
                checkpointer=checkpointer
            ),
            "tender_chatbot": await setup_tender_chatbot_graph(
                checkpointer=checkpointer
            ),
        }
    )
