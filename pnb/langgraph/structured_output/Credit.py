...
class Financial(BaseModel):
    title: str = Field(description="The title of the financial as in the response by the 'credit_assist_agent'")
    description: str = Field(description="The description of the financial as in the response by the 'credit_assist_agent'")

class aadhar(BaseModel):
    kyc_status: str = Field(description="The kyc status in  as in the response by the 'credit_assist_agent'")
    details: str = Field(description="The details in  as in the response by the 'credit_assist_agent'")

class pan(BaseModel):
    kyc_status: str = Field(description="The pan verification in  as in the response by the 'credit_assist_agent'")
    details: str = Field(description="The details in  as in the response by the 'credit_assist_agent'")


class Credit(BaseModel):
    review_set: ReviewSet = Field(description="The review set in  as in the response by the 'credit_assist_agent'")
    pan_verification: pan = Field(description="The pan verification in  as in the response by the 'credit_assist_agent'")
    aadhar_verification: aadhar = Field(description="The aadhar verification in  as in the response by the 'credit_assist_agent'")
